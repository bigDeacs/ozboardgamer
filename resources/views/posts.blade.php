		                ...
		                <div class="col-sm-12 post">
		                    ...
		                    <div class="row">
		                        <div class="col-sm-12 post-header-line">
		                            ...
		                            </span>{!! date('F d, Y', strtotime($post->published_at)) !!} | <span class="glyphicon glyphicon-comment"></span><span class="fb-comments-count" data-href="/{{ $category->slug }}/{{ $post->slug }}"></span>
		                        </div>
		                    </div>
