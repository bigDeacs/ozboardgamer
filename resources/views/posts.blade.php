							...
							@endif
                                ...
                                <div class="row">
                                    <div class="col-sm-12 post-header-line">
                                        ...
                                        </span><span itemprop="datePublished">{!! date('F d, Y', strtotime($post->published_at)) !!}</span> | <span class="glyphicon glyphicon-comment"></span><a href="{{ secure_url('/') }}/{{ $category->slug }}/{{ $post->slug }}#disqus_thread" data-disqus-identifier="{{ camel_case($post->name) }}"></a>
