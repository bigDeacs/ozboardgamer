...
@section('meta')
    <title>{{ $mechanic->name }} | Mechanics | Oz Board Gamer</title>
   	{!! $mechanic->meta !!}
@endsection
          ...
          @foreach($games as $game)
                    ...
                    @endif
  		                        ...
  		                        <div class="col-md-8 col-md-pull-2 col-sm-7 col-sm-pull-2 col-xs-12">
  		                            ...
  		                            <p>
  		                                <a class="btn btn-hot text-uppercase" href="/games/{{ $game->types()->first()->slug }}/{{ $game->slug }}"><span class="fa fa-arrow-circle-right"></span> Read more</a>
  		                            </p>
  		                        </div>
