...
<div class="form-group row">
      <div class="col-sm-6 col-xs-12">
	      ...
	      <input type="text" name="name" id="name" class="form-control" value="{{ isset($theme) ? $theme->name : old('name') }}" placeholder="" required>
      </div>
      <div class="col-sm-6 col-xs-12">
            <label for="slug">Slug</label>
            <input type="text" name="slug" id="slug" class="form-control" value="{{ isset($theme) ? $theme->slug : old('slug') }}" placeholder="" required>
      </div>
</div>
