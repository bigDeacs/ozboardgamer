		                ...
		                <div class="col-sm-12 post">
		                    ...
		                    <div class="row">
		                        <div class="col-sm-12 post-header-line">
		                            ...
		                            </span><span itemprop="datePublished">{!! date('F d, Y', strtotime($post->published_at)) !!}</span> | <span class="glyphicon glyphicon-comment"></span><span class="fb-comments-count" data-href="{{ secure_url('/') }}/{{ $category->slug }}/{{ $post->slug }}"></span>
