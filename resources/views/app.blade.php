...
<html lang="en">
  <head>
	...
	<!-- Instant Articles -->
	<meta property="fb:pages" content="489804094539472" />
    <meta charset="utf-8">
    ...
    <link href="https://css.ozboardgamer.com/css/style.min.css?v=102" rel="stylesheet">
		...
		<nav class="navbar navbar-dark bg-dark navbar-expand-md fixed-top">
			<div class="container">
				...
				<ul class="navbar-nav mr-auto float-right">
					...
					<li class="nav-item dropdown">
						<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Game Articles</a>
						<ul class="dropdown-menu">
