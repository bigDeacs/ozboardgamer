...
<html lang="en">
  ...
  <body>
    ...
    @if(Session::has('name'))
      ...
      <div id="offerCarousel" class="vertical-slider carousel vertical slide row" data-ride="carousel" style="{{ (Request::url() == 'https://ozboardgamer.com') ? 'padding-bottom: 10px;margin-bottom: -10px;' : 'padding-bottom: 10px;' }}">
          <!-- Carousel items -->
