													...
													<div class="col-12 col-md-6 p-0">
														...
														<div class="card border-0 rounded-0 text-white overflow zoom" itemscope itemtype="http://schema.org/Game">
															...
															<div class="position-relative">
																<!--thumbnail img-->
																<div class="ratio_right-cover-2 image-wrapper">
																	<a href="/{{ $blog->category()->first()->slug }}/{{ $blog->slug }}" title="{{ $blog->name }}">
																		@if ($key == 0)
																			@if($blog->hasGames())
																...
																<div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
																	<!-- category -->
																	<a class="p-2 badge badge-success rounded-0" href="/{{ $blog->category()->first()->slug }}">{{ $blog->category()->first()->name }}</a>

																	<!--title and description-->
																	<a href="/{{ $blog->category()->first()->slug }}/{{ $blog->slug }}">
																		<h2 class="h5 text-white my-1">
