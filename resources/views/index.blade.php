                        ...
                        <div class="col-xs-12">
                            ...
                            @foreach($top10s as $top10)
                                <div class="row post" style="margin-bottom: 15px;">
									...
									@else										
										<div class="col-sm-3 col-xs-12 hidden-xs" style="padding: 15px;">
											<a href="/top10s/{{ $top10->slug }}" title="{{ $top10->games()->random(1)->name }}">
												<img src="https://assets.ozboardgamer.com{{ $top10->games()->random(1)->thumb1x }}" srcset="https://assets.ozboardgamer.com{{ $top10->games()->random(1)->thumb1x }} 1x, https://assets.ozboardgamer.com{{ $top10->games()->random(1)->thumb2x }} 2x" alt="{{ $top10->games()->random(1)->name }}" class="img-responsive" itemprop="image" style="margin: auto;" />
											</a>
										</div>
										<div class="col-sm-9 col-xs-12">
									@endif
