      ...
      autocomplete('#search-terms', {hint: false}, [
        {
          ...
          templates: {
            ...
            footer: '<div class="pull-right col-lg-2 col-md-2 col-sm-3 col-xs-3">Search powered by <img src="/img/Algolia_logo_bg-white.jpg" class="img-responsive" /></div>',
      ...
      autocomplete('#search-stores', {hint: false}, [
        {
          ...
          templates: {
            ...
            suggestion: function(suggestion) {
              ...
              return '<a href="'+suggestion.slug+'"><div class="row">'+
                '<div class="col-xs-3"><img src="'+suggestion.thumb+'" class="img-responsive" /></div>'+
                '<div class="col-xs-9">'+suggestion._highlightResult.name.value+' ('+suggestion.abr+')'+'</div>'+
              '</div></a>';
            }
          }
        }
