      ...
      autocomplete('#search-terms', {hint: false}, [
        {
          ...
          templates: {
            ...
            footer: '<div class="pull-right col-xs-4"><img src="/img/Algolia_logo_bg-white.jpg" class="img-responsive" /></div>',
            suggestion: function(suggestion) {
              ...
              return '<a href="'+suggestion.slug+'"><div class="row">'+
                ...
                '<div class="col-xs-9"><div class="row"><div class="col-xs-12">'+suggestion._highlightResult.name.value+' ('+suggestion.published+')'+'</div>'+
                '<div class="col-xs-12 hidden-xs">'+suggestion._types.name.value+'</div></div></div>'+
              '</div></a>';
            }
          }
        }
      ...
      autocomplete('#search-stores', {hint: false}, [
        {
          ...
          templates: {
            ...
            suggestion: function(suggestion) {
              console.log(suggestion);
              return '<a href="'+suggestion.slug+'"><div class="row">'+
                '<div class="col-sm-2 col-xs-3"><img src="'+suggestion.thumb+'" class="img-responsive" /></div>'+
                '<div class="col-sm-10 col-xs-9"><div class="row"><div class="col-xs-12">'+suggestion._highlightResult.name.value+'</div>'+
                '<div class="col-xs-12 hidden-xs">'+suggestion.street+', '+suggestion.suburb+', '+suggestion.abr+' '+suggestion.postcode+'</div></div></div>'+
              '</div></a>';
            }
          }
        }
