          ...
          templates: {
            ...
            suggestion: function(suggestion) {
              ...
              return '<a href="'+suggestion.slug+'"><div class="row">'+
                ...
                '<div class="col-xs-8">'+suggestion._highlightResult.name.value+'</div>'+
                '<div class="col-xs-2"><img src="/img/'+Math.ceil(parseInt(suggestion._highlightResult.rating.value))+'.png" class="img-responsive" /></div>'+
              '</div></a>';              
            }
          }
        }
